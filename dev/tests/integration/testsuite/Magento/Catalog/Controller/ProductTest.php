...
class ProductTest extends AbstractController
{
    ...
    public function testViewAction(): void
    {
        ...
        $this->assertEquals(
            1,
            Xpath::getElementsCountForXpath(
                '//meta[@name="description" and @content="Simple Product 1 Meta Stock"]',
                $responseBody
            )
        );
    }
    ...
    #[
        ...
        DataFixture(
            Product::class,
            ['category_ids' => ['$category.id$'], 'short_description' => 'Product Short Stock'],
            as: 'sp'
        ),
        ...
        DataFixture(
            ...
            [
                'short_description' => 'Configurable Product Short Stock',
                '_options' => ['$attr$'],
                '_links' => ['$sp$']
            ],
            as: 'cp'
        ...
        DataFixture(
            ...
            [
                'short_description' => 'Bundle Product Short Stock',
                'sku' => 'bundle1',
                '_options' => ['$opt1$']
            ],
            as:'bp'
