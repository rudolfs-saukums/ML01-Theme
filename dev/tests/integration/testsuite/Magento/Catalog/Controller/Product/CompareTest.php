...
class CompareTest extends AbstractController
{
    ...
    public function testIndexActionDisplay(): void
    {
        ...
        $this->assertStringContainsString('Simple Product 1 Full Stock', $responseBody);
        $this->assertStringContainsString('Simple Product 1 Short Stock', $responseBody);
        ...
        $this->assertStringContainsString('Simple Product 2 Full Stock', $responseBody);
        $this->assertStringContainsString('Simple Product 2 Short Stock', $responseBody);
