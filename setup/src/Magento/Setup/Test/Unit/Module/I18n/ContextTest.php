...
class ContextTest extends TestCase
{
    ...
    public function dataProviderContextByPath()
    {
        return [
            ...
            [
                ...
                '/app/design/area/theme/Stock.phtml',
                [
            ...
            [
                [Context::CONTEXT_TYPE_LIB, 'lib/web/module/Stock.phtml'],
                '/lib/web/module/Stock.phtml',
                [
                    [Context::CONTEXT_TYPE_MODULE, []],
                    [Context::CONTEXT_TYPE_THEME, []],
                ]
    ...
    public function dataProviderPathToLocaleDirectoryByContext()
    {
        return [
            ...
            [BP . '/lib/web/i18n/', [Context::CONTEXT_TYPE_LIB, 'lib/web/module/Stock.phtml'], []],
        ];
    }
